...
if pastNN:
  score_cut = "&& (score5 <= 0.05)" #&& ((score0 > 0.3) || (score1 > 0.3) || (score2 > 0.5) || (score3 > 0.5))"
...
if pastNN:
  ...
  if constrained:
    ...
    chainSigSB, rdfSigSB     = getRdf(sig_cons_pastNN                          )#, debug = 1000)
    chainSig,   rdfSig       = getRdf(sig_cons_pastNN                          )#, debug = 1000)
