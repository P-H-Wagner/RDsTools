...
toSave_plots        = f"/work/pahwagne/RDsTools/corrections/combinatorial/{dt}/"
...
antiSignal  = "    (((m_shifted < 1.92) || (m_shifted > 2.02))||(m_shifted > 5.366))"
...
#  binning_str.append( f"( {split} > {b[0]} ) && ( {split} < {b[1]} )" + antiSignal)  
